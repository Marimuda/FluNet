...
class HomoMessagePassingBlock(AbstractMessagePassingBlock):
    ...
    def __init__(
        ...
        in_global_features: Optional[int] = 0,
        aggregation_function_str: str = "mean",
        edge_base_config: Optional[ConfigDict] = None,
        node_base_config: Optional[ConfigDict] = None,
        global_base_config: Optional[ConfigDict] = None,
        use_residual_connections: Optional[bool] = False,
    ):
        """
        Args:
        ...
        edge_module = EdgeModule(
            in_features=2 * in_node_features + in_edge_features + in_global_features,
            num_types=1,
        ...
        if in_global_features > 0:  # has global features
            ...
            if self.constant_global_features:
                global_module = GlobalModuleNoUpdate(
